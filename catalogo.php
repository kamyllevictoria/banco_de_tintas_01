                        ...
                        <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xxl-4">
                            <div class="card mb-3">
                                <div class="card-body text-start">
                                    <h4 class="card-title text_purple">#<?= $linha["identificacao"]; ?> Tinta
                                        <?= $linha["cor"]; ?>:
                                    </h4>
                                    ...
                                    <p class="card-text text_purple">
                                        Data de validade:
                                        <span
                                            class="text_green"><?= $dataValidade[2]; ?>/<?= $dataValidade[1]; ?>/<?= $dataValidade[0]; ?></span>
                                    </p>
                                    <p class="card-text text_purple">
                                        Data de recebimento:
                                        <span
                                            class="text_green"><?= $dataRecebimento[2]; ?>/<?= $dataRecebimento[1]; ?>/<?= $dataRecebimento[0]; ?></span>
                                    </p>
                                    <p class="card-text text_purple">
                                        Marca:
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-9 d-flex align-items-start">
                                            <img class="img-fluid" src="<?= $linha["imagem"]; ?>"
                                                style="height: 150px; width: auto;">
                                        </div>
                                        <div class="col-sm-3 d-flex flex-column align-items-end">
                                            <button class="btn btn-green btn_width trash_icon_position"
                                                id="btn-apagar<?= $linha["identificacao"]; ?>"
                                                onclick="modalApagar('<?= $linha['identificacao']; ?>')">
                                                <img src="./icones/lixo.png" class="icone_position" width="20px"
                                                    height="20px" alt="icone lixeira">
                                                Apagar Tinta
                                            </button>
                                            <form action="config/tintas_config.php" method="post">
                                                ...
                                                <div id="modalBackgroundApagar<?= $linha["identificacao"]; ?>"
                                                    class="modal-background"></div>
                                                <div id="modalContainerApagar<?= $linha["identificacao"]; ?>"
                                                    class="container-green">
                                                    <div class="close-modal"
                                                        onclick="fecharModalApagar('<?= $linha['identificacao']; ?>')">
                                                        <img src="imagens/fechar.png" width="50px">
                                                    </div>
                                                    <h4 class="text_purple pad_bottom_20">Apagar Tinta</h4>
                                                    <p class="delete-ink-message">Deseja mesmo apagar esta tinta
                                                        permanentemente?</p>
                                                    <button class="btn btn-purple-edit"
                                                        id="btnApagar<?= $linha["identificacao"]; ?>">Apagar</button>
                                                </div>

                                            </form>

                                            <button class="btn btn-green btn_width edit_icon_position"
                                                id="btn-alterar<?= $linha["identificacao"]; ?>"
                                                onclick="modal('<?= $linha['identificacao']; ?>')">
                                                <img src="./icones/editar.png" class="icone_position" width="20px"
                                                    height="20px" alt="icone editar">
                                                Alterar
                                            </button>
                                            <form action="config/tintas_config.php" method="post">
                                                ...
                                                <div id="modalBackground<?= $linha["identificacao"]; ?>"
                                                    class="modal-background"></div>
                                                <div id="modalContainer<?= $linha["identificacao"]; ?>"
                                                    class="container-green">
                                                    <div class="close-modal"
                                                        onclick="fecharModal('<?= $linha['identificacao']; ?>')">
                                                        <img src="imagens/fechar.png" width="50px">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control input-small"
                                                            placeholder="Marca"
                                                            name="marca<?= $linha["identificacao"]; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dataVencimento" class="text_purple">Data de
                                                            Vencimento:</label>
                                                        <input type="date" class="form-control input-small"
                                                            placeholder="12/05/2024"
                                                            name="dataVencimento<?= $linha["identificacao"]; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="quantidadeLatas" class="text_purple">Data de
                                                            recebimento</label>
                                                        <input type="date" class="form-control input-small"
                                                            placeholder="12/05/2024"
                                                            name="dataRecebimento<?= $linha["identificacao"]; ?>">
                                                    </div>
                                                    <div class="form-group pad_bottom_20">
                                                        <label for="volumeLitros" class="text_purple">Volume em
                                                            Litros:</label>
                                                        <input name="volume<?= $linha["identificacao"]; ?>"
                                                            type="number" step=".01" class="form-control input-small"
                                                            placeholder="Volume em litros">
                                                    </div>
                                                    <button class="btn btn-purple-edit"
                                                        id="btnSalvar<?= $linha["identificacao"]; ?>">Salvar</button>
                                                </div>
